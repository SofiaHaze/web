	...
	<div class="spacer">
		<div class="row contact">
			...
			<form method ="post" action="contact_update.php" enctype="multipart/form-data" id="contactid">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
				<input type="text" class="form-control" name="phone_number" id="phone_number" placeholder="연락처 (-를 제외하고 입력해주세요)">
				</div>

				<div class="col-lg-12 col-sm-12 col-xs-12">
				<textarea rows="6" class="form-control" name="consult" id="consult" placeholder="상담 내용"></textarea>
				</div>

				<button type="submit" class="btn btn-success" name="Submit" value=<?php echo $url;?>>상담 문의 남기기</button>
			</form>
