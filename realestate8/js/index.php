        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>              
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> 서울 광진구 자양로50길 9 (지번)구의동 31-17</p>
              <p>최선을 다해 정성껏 모시겠습니다.</p>
              <!--ssc-->
              <cite onclick="goToConsult()">상담 환영</cite>
              </blockquote>
            </div>
          </div>
    ...
    <div class="searchbar">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          <input type="text" class="form-control" placeholder="매물 검색하기">
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
              <select class="form-control">
                <option>가격</option>
                <option>1억 5천만원 이상 - 2억원 이하</option>
                <option>2억원 이상 - 2억 5천만원 이하</option>
                <option>2억 5천만원 이상- 3억 이하</option>
            ...
            <select class="form-control">
              ...
              <div class="col-lg-3 col-sm-4">
              <button class="btn btn-success"  onclick="window.location.href='buysalerent.php'">검색</button>
              </div>
          </div>
          
          </div>
          <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
          <p>회원가입을 원할 시 로그인 버튼을 클릭해주세요</p>
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-6 col-sm-9 recent-view">
        <h3>문의하기</h3>
        <p>상담을 원하시면 밑에 버튼을 클릭하세요.<br><a href="about.php">상담</a></p>
            ...
            <div class="item active">
              <div class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <a href="property-detail.php" class="more">상세정보 보기</a> </div>
              </div>
            </div>
            <div class="item">
              <div class="row">
