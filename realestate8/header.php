...
<a href="index.php"><img src="images/logo.png" alt="Realestate"></a>
              ...
              <ul class="pull-right">
                ...
                <li><a href="buy1.php?searchText=&searchColumn=매매&searchType=all">매매</a></li>
                <li><a href="buy1.php?searchText=&searchColumn=전세&searchType=all">전세</a></li>
                <li><a href="buy1.php?searchText=&searchColumn=월세&searchType=all">월세</a></li>
                <?php
                	if(isset($_SESSION['email'])) {
