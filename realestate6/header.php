...
<a href="index.php"><img src="images/logo.png" alt="Realestate"></a>
              ...
              ?>
              <ul class="pull-right">
                <li><a href="total_properties.php"><h4>전체 보기</h4></a></li>
                <li><a href="buy.php?searchText=&searchColumn=sell&searchType=all">매매</a></li>
                <li><a href="rent.php?searchText=&searchColumn=rent&searchType=all">전세</a></li>
                <li><a href="sale.php?searchText=&searchColumn=rentm&searchType=all">월세</a></li>
                <?php
                	 if(isset($_SESSION['email'])) {
