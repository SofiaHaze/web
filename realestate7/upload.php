  	...
  	<div class="col-lg-9 col-sm-8">
        ...
        ?>
              ...
              <div class="col-lg-3 col-sm-6 col-xs-6">
                <input type="text" class="form-control" name="name_dong" id="size" placeholder="동 이름"/>
              </div>

               <div class="col-lg-5 col-sm-6 col-xs-6">
                <input type="text" class="form-control" name="pos_park" id="price" placeholder="주차장 (존재시 1 없으면 0)"/>
              </div>
